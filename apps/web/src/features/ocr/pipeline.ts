...
function parseKV(text: string): Record<string, string | number | null> {
...
export async function digitizeTextToRecord(rawText: string): Promise<Record<string, string | number | null>> {
